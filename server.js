...
const server = http.createServer(function(req, res) {
    // Respond with OK message. Z. notes:  200 means it  works. 
    res.statusCode = 200;
    // The type of content we are returning. Just plain text.
    res.setHeader("Content-Type", "text/plain");
    // The plain text we are returning.
    res.end("Hello, " + req.url); // Z. note: req.url means you can put
    // your name after the  / in the link and it will show your name
    // on the page. 
});
